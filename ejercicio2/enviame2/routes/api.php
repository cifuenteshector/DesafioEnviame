...
use App\Http\Controllers\CntWorkerController;
...
Route::get('/getperson', [PersonController::class,'getPerson']);
Route::post('/deletecompany', [PersonController::class,'destroy']);
Route::post('/person', [PersonController::class,'store']);
Route::put('/updateperson', [PersonController::class,'update']);

//CRUD TRABAJADORES
Route::get('/allworker', [CntWorkerController::class,'show']);
Route::get('/getworker', [CntWorkerController::class,'getWorker']);
Route::post('/deleteworker', [CntWorkerController::class,'destroy']);
Route::post('/worker', [CntWorkerController::class,'store']);
Route::put('/updateworker', [CntWorkerController::class,'update']);